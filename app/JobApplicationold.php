...
class JobApplication extends Model
{
 ...
 protected $appends = ['resume_url','pcc_url','aadharfront_url','aadharback_url','passport_url','pancard_url','voterid_url','offerletter_url','appointmentletter_url','salaryslip_url','bankstatement_url'];
